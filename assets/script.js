...
//var countDownDate = new Date(timer).toDateString().getTime();
//var countDownDate = new Date("Sept 29, 2024 00:00:00").getTime();
...
var x = setInterval(function () {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown-content").innerHTML = "<p style='color:red'>FINALIZADO</p>";
  }
}, 1000);
